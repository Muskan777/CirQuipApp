...
const SellProductsStackScreen = ({navigation}) => (
  <SellProductsStack.Navigator screenOptions={{
    headerTitleStyle: {
      fontSize: 20,
    },
    headerStyle: {
...
const MyProductsStackScreen = ({navigation}) => (
  <MyProductsStack.Navigator screenOptions={{
    headerTitleStyle: {
      fontSize: 20,
    },
    headerStyle: {
...
const BuyRequestsScreen = ({navigation}) => (
  <BuyRequests.Navigator screenOptions={{
    headerTitleStyle: {
      fontSize: 20,
    },
    headerStyle: {
    ...
    <PaperProvider theme={theme}>
      <NavigationContainer>
       <Drawer.Navigator drawerContent={props => <DrawerContent {...props}/>}>
          ...
          <Drawer.Screen name="SellProducts" component={SellProductsStackScreen }/>
